...
// NewEventExt when the ID of an event is zero, it is reassigned a unique ID under source
...
// eg: ["data", "source"] -> e.Event.Data.source.
...
// to prevent precision overflow, id returns string type.
